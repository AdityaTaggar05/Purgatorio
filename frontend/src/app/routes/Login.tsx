    ...
    <>
      <AuthLayout title="PURGATORIO" subtitle="To see again the stars">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full font-serif bg-purgatory-border hover:bg-amber-950/40 border border-amber-500/30 hover:border-amber-500/60 text-gray-200 py-3 rounded text-sm tracking-widest font-semibold transition-all duration-300 mt-4 shadow-lg hover:cursor-pointer disabled:cursor-not-allowed"
            disabled={isSubmitting}>
            {isSubmitting ? 'ENTERING...' : 'ENTER THE GATE'}
          </button>
        </form>
