      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between items-center">
            <label htmlFor="password" className="text-xs uppercase tracking-wider text-gray-400 font-medium">
              Password
            </label>
            <a href="#forgot" className="text-xs text-amber-500/60 hover:text-amber-500 transition-colors">
              Lost your way?
            </a>
          </div>
